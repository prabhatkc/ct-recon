...
# ====================================================================
parser = argparse.ArgumentParser(description='Application of bilateral filter-based denoisers on CT images')
...
parser.add_argument('--sigma-spatial', type=float, default=5, help="std for pixel distance.\
                                                                     Larger value results in averaging of pixels in larger distance.")
parser.add_argument('--rNx', required=False, type=int, default=256, help="image size for raw image as input.")
args = parser.parse_args()

from blfdenoiser import blf_solver; blf_solver(args)
