...
%%
    ...
    % around 200 mAs, equivalent k factor is 0.85. 
    ...
    for i=1:Nz
	    ...
	    if strcmp(plot_figures, 'T')
		    ...
		    im(1, xtrue, 'high-dose'), cbar;
		    im(2, fbp, 'FBP low-dose'), cbar;
		    im(3, ndsino_n, 'sino'), cbar;
		    im(4, ndsino, 'noisy sino'), cbar;
        end 
